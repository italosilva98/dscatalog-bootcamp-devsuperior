...
public class ProductService {
	...
	@Transactional(readOnly = true) // Métodos para fazer transações em BD, readOnly = para operação apenas de
									// leitura
	...
	public ProductDTO findById(Long id) {
		...
		Product entity = obj.orElseThrow(() -> new ResourceEntityNotFoundException("Entity not found")); // caso nao
																											// exista o
																											// obj,
																											// chama uma
																											// exceção
